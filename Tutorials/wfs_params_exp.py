...
WFSParams = dict(
    {
        "Nres": 40,  # Number of pixels in the aperture of the telescope
        "sampling": 120 / 40,  # Zero-padding factor (2 is Shannon)
        "Bin_factor": 20 / 20,
        ...
        "Nactuator": 9,  # Number of actuators across the diameter of the DM
