...
class WFS:
    def __init__(self, resolution, sampling, diameter, Nphotons, RON):
        """
...
Nphases = 50                                                                    # Number of independent phase screens to simulate
...
wfs = WFS(Nres, sampling, D, Nphotons, RON)
